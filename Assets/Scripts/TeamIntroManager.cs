...
public class TeamIntroManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        oppTeamLogo.sprite = teamList[PlayerPrefs.GetInt("OppTeamSelected")].TeamSprite;
        oppTeamName.text = teamList[PlayerPrefs.GetInt("OppTeamSelected")].TeamName;
