...
public class GameBracketL1Controller : MonoBehaviour {
    ...
    private void AnswerChoices()
    {
        for (int i = 0; i < currentQuestion.answers.Length; i++) 
        {
            ...
            L1AnswerButton answerButton = answerButtonGameObject.GetComponent<L1AnswerButton>();
    ...
    public void EndRound()
    {
        ...
        oppEndLogo.sprite = teamList[PlayerPrefs.GetInt("OpponentL1Index")].teamLogo;
    ...
    private void SetL2Opponent()
    {
       ...
       // int king = 9;
        ...
        switch(playerTeamIndex)
        {
            ...
            case 0:
                PlayerPrefs.SetInt("OpponentL2Index", ray);
                break;
            case 1:
                PlayerPrefs.SetInt("OpponentL2Index", collegiate);
                break;
            case 2:
                PlayerPrefs.SetInt("OpponentL2Index", veteransMemorial);
                break;
            case 3:
                PlayerPrefs.SetInt("OpponentL2Index", ray);
                break;
            case 4:
                PlayerPrefs.SetInt("OpponentL2Index", vicEast);
                break;
            case 5:
                PlayerPrefs.SetInt("OpponentL2Index", london);
                break;
            case 6:
                PlayerPrefs.SetInt("OpponentL2Index", portA);
                break;
            case 7:
                PlayerPrefs.SetInt("OpponentL2Index", portA);
                break;
            case 8:
                PlayerPrefs.SetInt("OpponentL2Index", kaufer);
                break;
            case 9:
                PlayerPrefs.SetInt("OpponentL2Index", miller);
                break;
            case 10:
                PlayerPrefs.SetInt("OpponentL2Index", sinton);
                break;
            case 11:
                PlayerPrefs.SetInt("OpponentL2Index", tuloso);
                break;
            case 12:
                PlayerPrefs.SetInt("OpponentL2Index", tuloso);
                break;
            case 13:
                PlayerPrefs.SetInt("OpponentL2Index", gp);
                break;
            case 14:
                PlayerPrefs.SetInt("OpponentL2Index", miller);
                break;
            case 15:
                PlayerPrefs.SetInt("OpponentL2Index", calallen);
                break;
            case 16:
                PlayerPrefs.SetInt("OpponentL2Index", london);
                break;
            ...
            case 23:
                ...
                break;
            default:
                Debug.Log("Error during setting opponent L2 Index.");
                break;
        }
    ...
    public void ScoreBoardMenu()
    {
        ...
        oppTeam = PlayerPrefs.GetInt("OpponentL1Index");
        switch (oppTeam)
        {  
            case 0:
