...
public class GameBracketL5Controller : MonoBehaviour {
    ...
    [SerializeField] private Image champLogo;
    ...
    private void AnswerChoices()
    {
        for (int i = 0; i < currentQuestion.answers.Length; i++) 
        {
            ...
            L5AnswerButton answerButton = answerButtonGameObject.GetComponent<L5AnswerButton>();
    ...
    public void EndRound()
    {
        ...
        oppEndLogo.sprite = teamList[PlayerPrefs.GetInt("OpponentL5Index")].teamLogo;
    ...
    public void ScoreBoardMenu()
    {
        ...
        oppTeam = PlayerPrefs.GetInt("OpponentL5Index");
        switch (oppTeam)
        {  
            case 0:
    ...
    private void SetPlayer()
    {
        ...
        switch(playerTeamIndex)
        {
            ...
            case 0:
                ...
                champLogo.sprite = teamList[playerTeamIndex].teamLogo;
