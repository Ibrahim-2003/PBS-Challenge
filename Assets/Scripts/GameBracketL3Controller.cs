...
public class GameBracketL3Controller : MonoBehaviour {
    ...
    private void AnswerChoices()
    {
        for (int i = 0; i < currentQuestion.answers.Length; i++) 
        {
            ...
            L3AnswerButton answerButton = answerButtonGameObject.GetComponent<L3AnswerButton>();
    ...
    public void EndRound()
    {
        ...
        oppEndLogo.sprite = teamList[PlayerPrefs.GetInt("OpponentL3Index")].teamLogo;
    ...
    private void SetL2Opponent()
    {
        ...
        switch(playerTeamIndex)
        {
            ...
            case 0:
                PlayerPrefs.SetInt("OpponentL4Index", london);
                break;
            case 1:
                PlayerPrefs.SetInt("OpponentL4Index", gp);
                break;
            case 2:
                PlayerPrefs.SetInt("OpponentL4Index", london);
                break;
            case 3:
                ...
                break;
            case 4:
                PlayerPrefs.SetInt("OpponentL4Index", veteransMemorial);
                break;
            case 5:
                PlayerPrefs.SetInt("OpponentL4Index", veteransMemorial);
                break;
            case 6:
                PlayerPrefs.SetInt("OpponentL4Index", sinton);
                break;
            case 7:
                PlayerPrefs.SetInt("OpponentL4Index", sinton);
                break;
            ...
            case 23:
                ...
                break;
            default:
                Debug.Log("Error during setting opponent L4 Index.");
                break;
        }
    ...
    private void TieBreaker()
    {
        ...
        SceneManager.LoadScene("BracketL3");
    }
    ...
    public void ScoreBoardMenu()
    {
        ...
        oppTeam = PlayerPrefs.GetInt("OpponentL3Index");
        switch (oppTeam)
        {  
            case 0:
