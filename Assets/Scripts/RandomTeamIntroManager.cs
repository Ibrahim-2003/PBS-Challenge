...
public class RandomTeamIntroManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerTeamLogo.sprite = teamList[PlayerPrefs.GetInt("TeamSelected")].TeamSprite;
        playerTeamName.text = teamList[PlayerPrefs.GetInt("TeamSelected")].TeamName;

        oppTeamLogo.sprite = teamList[PlayerPrefs.GetInt("OppRandomTeamSelected")].TeamSprite;
        oppTeamName.text = teamList[PlayerPrefs.GetInt("OppRandomTeamSelected")].TeamName;
    ...
    private void Transition()
    {
        ...
        SceneManager.LoadScene("GameCopy.unity");
    }
