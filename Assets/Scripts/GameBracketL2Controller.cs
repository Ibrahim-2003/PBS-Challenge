...
public class GameBracketL2Controller : MonoBehaviour {
    ...
    [SerializeField] private Image play3Logo;
    [SerializeField] private Image play4Logo;
    ...
    private void AnswerChoices()
    {
        for (int i = 0; i < currentQuestion.answers.Length; i++) 
        {
            ...
            L2AnswerButton answerButton = answerButtonGameObject.GetComponent<L2AnswerButton>();
    ...
    public void EndRound()
    {
        ...
        oppEndLogo.sprite = teamList[PlayerPrefs.GetInt("OpponentL2Index")].teamLogo;
    ...
    private void SetL2Opponent()
    {
        ...
        switch(playerTeamIndex)
        {
            ...
            case 0:
                PlayerPrefs.SetInt("OpponentL3Index", tuloso);
                break;
            case 1:
                PlayerPrefs.SetInt("OpponentL3Index", calallen);
                break;
            case 2:
                PlayerPrefs.SetInt("OpponentL3Index", tuloso);
                break;
            case 3:
                ...
                break;
            case 4:
                PlayerPrefs.SetInt("OpponentL3Index", london);
                break;
            case 5:
                PlayerPrefs.SetInt("OpponentL3Index", london);
                break;
            case 6:
                PlayerPrefs.SetInt("OpponentL3Index", gp);
                break;
            case 7:
                PlayerPrefs.SetInt("OpponentL3Index", gp);
                break;
            case 8:
                PlayerPrefs.SetInt("OpponentL3Index", sinton);
                break;
            case 9:
                PlayerPrefs.SetInt("OpponentL3Index", veteransMemorial);
                break;
            case 10:
                PlayerPrefs.SetInt("OpponentL3Index", calallen);
                break;
            ...
            case 23:
                ...
                break;
            default:
                Debug.Log("Error during setting opponent L3 Index.");
                break;
        }
    ...
    private void TieBreaker()
    {
        ...
        SceneManager.LoadScene("BracketL2");
    }
    ...
    public void ScoreBoardMenu()
    {
        ...
        oppTeam = PlayerPrefs.GetInt("OpponentL2Index");
        switch (oppTeam)
        {  
            case 0:
    ...
    {
        if(PlayerPrefs.GetInt("CareerTeamSelected") == 4 || PlayerPrefs.GetInt("CareerTeamSelected") == 21 ||
        PlayerPrefs.GetInt("CareerTeamSelected") == 5 || PlayerPrefs.GetInt("CareerTeamSelected") == 16 || 
        PlayerPrefs.GetInt("CareerTeamSelected") == 22 || PlayerPrefs.GetInt("CareerTeamSelected") == 13 || 
        PlayerPrefs.GetInt("CareerTeamSelected") == 7 || PlayerPrefs.GetInt("CareerTeamSelected") == 6)
        {
            SceneManager.LoadScene("L4Showcase");
        }else{
            SceneManager.LoadScene("L3Showcase");
        }
    }
    ...
    private void SetPlayer()
    {
        ...
        switch(playerTeamIndex)
        {
            ...
            case 0:
                ...
                play3Logo.sprite = teamList[london].teamLogo;
                play4Logo.sprite = teamList[sinton].teamLogo;
            ...
            case 1:
                ...
                play2Logo.sprite = teamList[tuloso].teamLogo;
                play3Logo.sprite = teamList[london].teamLogo;
                play4Logo.sprite = teamList[playerTeamIndex].teamLogo;
                play5Logo.sprite = teamList[calallen].teamLogo;
                play6Logo.sprite = teamList[gp].teamLogo;
            ...
            case 4:
                ...
                play1Logo.sprite = teamList[veteransMemorial].teamLogo;
                play2Logo.sprite = teamList[tuloso].teamLogo;
                play3Logo.sprite = teamList[playerTeamIndex].teamLogo;
                play4Logo.sprite = teamList[sinton].teamLogo;
                play5Logo.sprite = teamList[calallen].teamLogo;
                play6Logo.sprite = teamList[gp].teamLogo;
