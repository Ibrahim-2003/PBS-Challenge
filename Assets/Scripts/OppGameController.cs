...
public class OppGameController : MonoBehaviour {
    ...
    private void AnswerChoices()
    {
        for (int i = 0; i < currentQuestion.answers.Length; i++) 
        {
            ...
            //Change this to the new prefab name by scene
            OppAnswerButton answerButton = answerButtonGameObject.GetComponent<OppAnswerButton>();
    ...
    public void EndRound()
    {
        ...
        //This adds team logos to end screen
        myEndLogo.sprite = teamList[PlayerPrefs.GetInt("TeamSelected")].teamLogo;
        oppEndLogo.sprite = teamList[PlayerPrefs.GetInt("OppTeamSelected")].teamLogo;
    ...
    {
        SceneManager.LoadScene("SelectOppTeam");
    }

    public void ScoreBoardMenu()
    {
        string teamName = PlayerPrefs.GetString("TeamName");
        teamNamePlayer.text = teamName;
        smallteamNamePlayer.text = teamName;
        int myTeamIndex = PlayerPrefs.GetInt("TeamSelected");
        ...
        int oppTeam = PlayerPrefs.GetInt("OppTeamSelected");
        switch (oppTeam)
        {  
            case 0:
